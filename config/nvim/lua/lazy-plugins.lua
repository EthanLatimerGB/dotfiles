require("lazy").setup({
    ...
    { "Bilal2453/luvit-meta", lazy = true },
    {
        ...
        config = function()
            ...
            -- Ragebait vue-ls configuration which is stupid, this is the only way atm and reference is here:
            -- https://www.reddit.com/r/neovim/comments/1mbk9sk/cannot_install_vue_ls_after_version_upgrade_to_v3/
            -- Custom paths for attaching
